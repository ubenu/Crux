...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("Images/BiscuitSave.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("Images/BiscuitFunction.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_select_function.setIcon(icon1)
        self.action_select_function.setObjectName("action_select_function")
        self.action_create = QtWidgets.QAction(MainWindow)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("Images/BiscuitNew.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_create.setIcon(icon2)
        self.action_create.setObjectName("action_create")
        self.action_open = QtWidgets.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("Images/BiscuitOpen.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_open.setIcon(icon3)
        self.action_open.setObjectName("action_open")
        self.action_analyze = QtWidgets.QAction(MainWindow)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("Images/BiscuitFit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_analyze.setIcon(icon4)
        self.action_analyze.setObjectName("action_analyze")
        self.action_close = QtWidgets.QAction(MainWindow)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("Images/BiscuitClose.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_close.setIcon(icon5)
        self.action_close.setObjectName("action_close")
        self.action_estimate = QtWidgets.QAction(MainWindow)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("Images/BiscuitEstimate.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_estimate.setIcon(icon6)
        self.action_estimate.setObjectName("action_estimate")
        self.action_apply = QtWidgets.QAction(MainWindow)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("Images/BiscuitCalculate.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_apply.setIcon(icon7)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_create.setToolTip(_translate("MainWindow", "Create data set"))
        self.action_open.setText(_translate("MainWindow", "Open data set"))
        self.action_open.setToolTip(_translate("MainWindow", "Open data set"))
